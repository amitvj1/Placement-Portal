<?php
            ...
            $i=0;
            $arr=array(); 
            $result=mysql_query("SELECT title,tags,qid from forum.question");
            if ($result) 
            {
