...
$query=mysql_query("SELECT * FROM com_basic where name='$usn' and email='$email'");
if($query)
{
...
if(!$query1)
	...
	echo "<script type='text/javascript'>window.location.href= 'company_forgot.html';</script>";
}
else
{
...
{
	echo "<script type='text/javascript'>alert(' no such entry in Database!')</script>";
