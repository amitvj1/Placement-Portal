...
//$name=$_SESSION['name'];
$i=0;
$ins = mysql_query("SELECT nid,title,content,file_name FROM notification WHERE type='s' order by nid desc");
	...
	<head>
		...
		function init()
		{
			...
			while(i<title_arr.length)
			{
				...
				tr4.id="41"+i;
				//td22.id="22"+i;
				tr3.innerHTML="attachments(click to download):<br/> <a href='downloadadminattach.php?fileid="+nid_arr[i]+"''>"+name_arr[i]+"</a> ";
				td12.innerHTML=" ==> ";
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" id="a_name" name="a_name" href="#">Student Profile  PES University Placement Portal</a>
				</div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header" style="background-color:grey;text-align:center">Notifications</h1>
