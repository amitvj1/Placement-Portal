...
<html lang="en">
	...
	<body onload="init()">
			...
			<div class="row">
				...
				<<div id ="logo"class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="table-responsive">
						...
						<form name="htmlform" method="post" action="fill_comapny.php">
		<table width="450px">
		...
		<tr>
			...
			<td valign="top">
				<input  type="password" id="p1" maxlength="50" size="30">
					<br></br>
			</td>
		</tr>
		...
		<tr>
			...
			<td valign="top">
				<input  type="password" id="p2" maxlength="50" size="30" onblur="fun()">
					<br></br>
			</td>
		</tr>
		<br>
