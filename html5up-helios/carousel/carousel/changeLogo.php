...
<html lang="en">
	<head>
		...
		<title>Logo-Companies-PESU</title>
			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="changeLogo.php">Update Logo<span class="sr-only">(current)</span></a></li>
				...
				<<div id ="logo"class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<img src="" id="img" name="img" alt=" No Image available" width="250" height="250">
					</br>
					<div id="div_logo">
					<form action="fill_logo.php" method="post" enctype="multipart/form-data">
					</br>
