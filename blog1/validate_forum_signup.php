    ...
    $password1=mysql_real_escape_string($_POST['password']);//$name1
...
define("HASH_PBKDF2_INDEX", 3);
    ...
    if(!$ins)
    {
      ...
      echo "<script type='text/javascript'>window.location.href= 'http://localhost/bootstrap-3.3.2/docs/examples/html5up-helios/carousel/carousel/forum_signup.html';</script>";
...
function pbkdf2($algorithm, $password, $salt, $count, $key_length, $raw_output = false)
{
    ...
    if(!in_array($algorithm, hash_algos(), true))
        trigger_error('PBKDF2_ITERATIONSF2 ERROR: Invalid hash algorithm.', E_USER_ERROR);
