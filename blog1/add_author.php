...
//search by the author name.
        ...
        session_start();
          ...
          else
          {
            ...
            $j=0;
            $arr=array(); 
            $result =mysql_query("SELECT a.answer,a.user,q.question from question q,answer a where q.qid = a.qid and a.user ='".$author."'");       //add the respective questions too
            if ($result) 
            {
