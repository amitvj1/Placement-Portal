<?php
          //searching a question bassed on the author of the answer and the tag of the question
//particularly useful when you want to search a particular person's answer on a certain topic
  ...
  h5
  {
    ...
    color: red;
      ...
      function loadAuthorandTags()
      {
        ...
        author_results.innerHTML = "More answers by "+auth+" on " + "'"+tags+"'";
